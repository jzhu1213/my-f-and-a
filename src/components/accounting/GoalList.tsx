  ...
  return (
    <div>
            ...
            >
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <span style={{ fontSize: '15px', color: 'var(--text)' }} className="truncate">
                    {goal.name}
                  </span>
                </div>
                <span style={{ fontFamily: 'Space Mono, monospace', fontSize: '13px', color: 'var(--sub)', flexShrink: 0 }}>
                  {Math.round(pct)}%
                </span>
              </div>
              ...
              <div className="flex justify-between">
                <span style={{ fontFamily: 'Space Mono, monospace', fontSize: '13px', color: 'var(--sub)' }}>
      ...
      <GoalSheet
        ...
        editGoal={editing ? { id: editing.id, name: editing.name, targetAmount: editing.targetAmount, emoji: editing.emoji } : undefined}
      />
      <GoalContributeSheet
        isOpen={showContribute}
        onClose={() => { setShowContribute(false); setSelected(null) }}
        goal={selected}
